...
@section('page-description', 'Nhập thông tin và tải poster phim')
...
@section('content')
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ml-1 text-sm font-medium text-white md:ml-2">Thêm mới</span>
        </div>
      </li>
    </ol>
  </nav>
  ...
  <div class="space-y-4">
    <div class="flex justify-between items-center">
      <h1 class="text-xl font-semibold">Thêm phim mới</h1>
      <a href="{{ route('admin.movies.index') }}" class="inline-flex items-center px-4 py-2 rounded-lg border border-[#2f3240] text-sm text-[#a6a6b0] hover:bg-[#222533]">
    ...
    <div class="bg-[#151822] border border-[#262833] rounded-xl p-5">
      <form action="{{ route('admin.movies.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div class="lg:col-span-2 space-y-4">
            <div>
              ...
              <input id="ten_phim" name="ten_phim" type="text" value="{{ old('ten_phim') }}" required class="w-full px-3 py-2 bg-[#1a1d24] border border-[#262833] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#F53003] @error('ten_phim') ring-2 ring-red-500 @enderror">
            ...
            <div>
              ...
              <input id="ten_goc" name="ten_goc" type="text" value="{{ old('ten_goc') }}" placeholder="Tên phim bằng ngôn ngữ gốc" class="w-full px-3 py-2 bg-[#1a1d24] border border-[#262833] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#F53003] @error('ten_goc') ring-2 ring-red-500 @enderror">
            ...
            <div>
              ...
              <textarea id="mo_ta" name="mo_ta" rows="4" required class="w-full px-3 py-2 bg-[#1a1d24] border border-[#262833] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#F53003] @error('mo_ta') ring-2 ring-red-500 @enderror">{{ old('mo_ta') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input id="dao_dien" name="dao_dien" type="text" value="{{ old('dao_dien') }}" required class="w-full px-3 py-2 bg-[#1a1d24] border border-[#262833] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#F53003] @error('dao_dien') ring-2 ring-red-500 @enderror">
              ...
              <div>
                ...
                <input id="do_dai" name="do_dai" type="number" value="{{ old('do_dai') }}" min="1" max="600" required class="w-full px-3 py-2 bg-[#1a1d24] border border-[#262833] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#F53003] @error('do_dai') ring-2 ring-red-500 @enderror">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input id="the_loai" name="the_loai" type="text" value="{{ old('the_loai') }}" placeholder="Hành động, Tình cảm, Hài hước..." class="w-full px-3 py-2 bg-[#1a1d24] border border-[#262833] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#F53003] @error('the_loai') ring-2 ring-red-500 @enderror">
              ...
              <div>
                ...
                <input id="quoc_gia" name="quoc_gia" type="text" value="{{ old('quoc_gia') }}" placeholder="Việt Nam, Mỹ, Hàn Quốc..." class="w-full px-3 py-2 bg-[#1a1d24] border border-[#262833] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#F53003] @error('quoc_gia') ring-2 ring-red-500 @enderror">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input id="ngon_ngu" name="ngon_ngu" type="text" value="{{ old('ngon_ngu') }}" placeholder="Tiếng Việt, English, 한국어..." class="w-full px-3 py-2 bg-[#1a1d24] border border-[#262833] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#F53003] @error('ngon_ngu') ring-2 ring-red-500 @enderror">
              ...
              <div>
                ...
                <select id="do_tuoi" name="do_tuoi" class="w-full px-3 py-2 bg-[#1a1d24] border border-[#262833] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#F53003] @error('do_tuoi') ring-2 ring-red-500 @enderror">
                  ...
                  <option value="P" {{ old('do_tuoi') == 'P' ? 'selected' : '' }}>P - Phổ biến</option>
                  <option value="C13" {{ old('do_tuoi') == 'C13' ? 'selected' : '' }}>C13 - Trên 13 tuổi</option>
                  <option value="C16" {{ old('do_tuoi') == 'C16' ? 'selected' : '' }}>C16 - Trên 16 tuổi</option>
                  <option value="C18" {{ old('do_tuoi') == 'C18' ? 'selected' : '' }}>C18 - Trên 18 tuổi</option>
                </select>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input id="ngay_khoi_chieu" name="ngay_khoi_chieu" type="date" value="{{ old('ngay_khoi_chieu') }}" class="w-full px-3 py-2 bg-[#1a1d24] border border-[#262833] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#F53003] @error('ngay_khoi_chieu') ring-2 ring-red-500 @enderror">
              ...
              <div>
                ...
                <input id="ngay_ket_thuc" name="ngay_ket_thuc" type="date" value="{{ old('ngay_ket_thuc') }}" class="w-full px-3 py-2 bg-[#1a1d24] border border-[#262833] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#F53003] @error('ngay_ket_thuc') ring-2 ring-red-500 @enderror">
            ...
            <div>
              ...
              <input id="trailer" name="trailer" type="url" value="{{ old('trailer') }}" placeholder="https://youtube.com/watch?v=..." class="w-full px-3 py-2 bg-[#1a1d24] border border-[#262833] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#F53003] @error('trailer') ring-2 ring-red-500 @enderror">
        ...
        <div class="pt-2 flex items-center gap-2">
          <button type="submit" class="inline-flex items-center px-4 py-2 rounded-lg bg-[#F53003] hover:bg-[#e02a00] text-white text-sm font-semibold">
            <i class="fas fa-save mr-2"></i> Lưu phim
          </button>
          <a href="{{ route('admin.movies.index') }}" class="inline-flex items-center px-4 py-2 rounded-lg border border-[#2f3240] text-sm text-[#a6a6b0] hover:bg-[#222533]">
