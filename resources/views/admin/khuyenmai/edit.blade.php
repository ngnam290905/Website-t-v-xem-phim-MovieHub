...
<div class="max-w-4xl mx-auto">
    <div class="mb-6 flex justify-between items-center">
        <h1 class="text-2xl font-bold">Sửa mã khuyến mãi</h1>
        <a href="{{ route('admin.khuyenmai.index') }}" class="px-4 py-2 rounded bg-gray-500 hover:bg-gray-600 text-white transition-colors">
            ← Quay lại
        </a>
    </div>

    <form action="{{ route('admin.khuyenmai.update', $khuyenmai->id) }}" method="POST" class="bg-[#151822] p-8 rounded-xl border border-[#262833]">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 gap-4">
                <div>
                    ...
                    <textarea name="mo_ta" rows="2" class="w-full px-4 py-2 rounded bg-[#222533] border border-[#262833] focus:outline-none focus:border-blue-500 transition-colors" placeholder="VD: Giảm giá cho khách hàng thân thiết">{{ old('mo_ta', $khuyenmai->mo_ta) }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" name="ma_km" class="w-full px-4 py-2 rounded bg-[#222533] border border-[#262833] focus:outline-none focus:border-blue-500 transition-colors uppercase" placeholder="VD: SUMMER2025" value="{{ old('ma_km', $khuyenmai->ma_km) }}">
        ...
        <div class="mb-6">
            ...
            <div>
                ...
                <input type="text" name="dieu_kien" class="w-full px-4 py-2 rounded bg-[#222533] border border-[#262833] focus:outline-none focus:border-purple-500 transition-colors" placeholder="VD: Áp dụng cho đơn hàng từ 200.000đ" value="{{ old('dieu_kien', $khuyenmai->dieu_kien) }}">
        ...
        <div class="flex justify-end gap-3 pt-4 border-t border-[#262833]">
            ...
            <button type="submit" class="px-6 py-2.5 rounded bg-blue-600 hover:bg-blue-700 text-white font-semibold transition-colors flex items-center gap-2">
