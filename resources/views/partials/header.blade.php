<header class="bg-[#1b1d24] border-b border-[#262833]">
  <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between gap-6">
    ...
    <nav class="hidden md:flex items-center gap-10 text-[15px]">
      ...
      <a href="{{ route('public.movies') }}" class="hover:text-[#F53003] transition">Phim</a>
      <a href="{{ route('public.schedule') }}" class="hover:text-[#F53003] transition">Lịch chiếu</a>
      <a href="{{ route('public.combos') }}" class="hover:text-[#F53003] transition">Combo</a>
      <a href="{{ route('public.news') }}" class="hover:text-[#F53003] transition">Tin tức</a>
