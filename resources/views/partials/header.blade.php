    ...
    <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between gap-6">
        ...
        <nav class="hidden md:flex items-center gap-10 text-[15px]">
            ...
            <div class="relative group">
                ...
                <div
                    class="absolute left-0 mt-3 hidden group-hover:block bg-[#0f0f12] border border-[#262833] rounded-md shadow-xl min-w-[180px] p-2">
        ...
        <div class="flex items-center gap-4 text-[15px]">
            <a href="#ve" class="hidden sm:inline-flex items-center gap-2 hover:text-[#F53003]">
                <span
                    class="inline-flex h-5 w-5 items-center justify-center rounded-full bg-white text-[#1b1d24] font-bold">✓</span>
                Vé
            </a>
                ...
                <div class="flex items-center gap-4">
                    ...
                    @if (in_array(optional(auth()->user()->vaiTro)->ten, ['admin', 'staff']))
                        <a href="{{ route('admin.dashboard') }}"
                            class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-[#F53003] hover:bg-[#e02a00] transition">
            ...
            @else
                <a href="{{ route('login.form') }}" class="inline-flex items-center gap-2 hover:text-[#F53003]">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <path fill-rule="evenodd" d="M2 20.25C2 16.245 5.134 13 9 13h6c3.866 0 7 3.245 7 7.25v.75H2v-.75z"
                            clip-rule="evenodd" />
                    </svg>
                    Đăng nhập
                </a>
                <a href="{{ route('register.form') }}"
                    class="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-[#F53003] text-[#ff7a5f] hover:bg-[#2a2d3a]">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12 12a5 5 0 100-10 5 5 0 000 10z" />
